...
export const allAppointmentDateReducer = (
  state = { appointmentdates: [] },
  action
) => {
  switch (action.type) {
    case APPOINTMENT_DETAILS_REQUEST:
      return { loading: true, appointmentdates: [] };
    case APPOINTMENT_DETAILS_SUCCESS:
      return {
        loading: false,
...
export const orderPayReducer = (state = { orderupdate: {} }, action) => {
  switch (action.type) {
