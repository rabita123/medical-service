...
export const DOCTOR_LIST_BY_SPECIALITY_REQUEST =
  "DOCTOR_LIST_BY_SPECIALITY_REQUEST";
export const DOCTOR_LIST_BY_SPECIALITY_SUCCESS =
  "DOCTOR_LIST_BY_SPECIALITY_SUCCESS";
export const DOCTOR_LIST_BY_SPECIALITY_FAIL = "DOCTOR_LIST_BY_SPECIALITY_FAIL";
